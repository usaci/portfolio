...
:root {
 ...
 body {
  color: #28282A;
  background: linear-gradient(180deg, #F1F0EF 0%, #E7E3E0 100%);;
  font-size: 1.7rem;
  font-family: 'Helvetica','degular-display', 'Noto Sans JP', 'Hiragino Sans', 'Hiragino Kaku Gothic Pr6N', 'YuGothic', 'Yu Gothic',  Meiryo UI, sans-serif;
  line-height: 1.7;
  font-weight: 400;
  min-height: 100svh;
